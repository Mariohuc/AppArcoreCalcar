...
public class Functions
{
	...
	private static GraphFunction[] functionsList = {
		Functions.SineFunction, Functions.Sine2DFunction, Functions.MultiSineFunction, Functions.MultiSine2DFunction,
		Functions.Ripple, Functions.Cylinder, Functions.Sphere, Functions.Torus
	};


	public static GraphFunction getFunction( FunctionName function ) {
		return functionsList[(int)function];
	}
